...
| Maven resolve failures | `lightwell-maven-settings` secret; public demo repos in `pom.xml`. Customers who centralize remotes: proxy Lightwell via Artifactory or Nexus using the sibling repo `lightwell-integrations` |
